...
- src/utils/animation-manager.js
- src/utils/combat-manager.js
- src/utils/crew-manager.js
- src/utils/fighter-ai/profiles/Soldier.js
- src/components/animation-tile.js
- src/pages/CombatSimulator.js
- src/pages/CrewManagerPage.js
- src/pages/dungonBuilderViews/DungeonView.js
- src/pages/UserManagerPage.js
- src/styles/monster-battle.scss
- src/App.js
- src/App.scss

**Summary generated by GitHub Copilot on December 5, 2025.**
