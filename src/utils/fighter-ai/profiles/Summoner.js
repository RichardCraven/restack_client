// Basic AI profile scaffold for the Summoner class.
export function Summoner(data, utilMethods, animationManager, overlayManager) { // eslint-disable-line no-unused-vars
