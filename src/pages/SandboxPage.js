...
const fightersData = [
  {
    ...
    portrait: rogue,
    abilities: [
      { id: 'stab', name: 'Stab', desc: 'Lunge forward and slice the target.', icon: claws, type: 'melee' },
      { id: 'throw_dagger', name: 'Throw Dagger', desc: 'Fling a spinning blade.', icon: axe_throw, type: 'projectile', projectileIcon: claws },
      { id: 'shadowstep', name: 'Shadowstep', desc: 'Teleport behind target, strike, and return.', icon: voidfill, type: 'teleport' },
      { id: 'poison_strike', name: 'Poison Strike', desc: 'Melee hit leaving a toxic green aura.', icon: grasp, type: 'melee_poison' }
    ]
  },
  {
    id: 'sage',
